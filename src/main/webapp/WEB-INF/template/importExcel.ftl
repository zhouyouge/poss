z	<script type="text/javascript" src="../statics/js/jquery-1.12.4.min.js"></script>
...
<div class="col-xs-12">
	<form action="traderecord/importExcel" name="Form" id="Form" method="post" enctype="multipart/form-data">
		<div id="zhongxin">
